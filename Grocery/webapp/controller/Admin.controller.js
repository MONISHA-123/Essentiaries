...
"sap/ui/core/mvc/Controller",
	...
	/*	fnChangeProdStatus:function(oEvent){
		...
		fnOnNewProduct: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("idNewProduct", "com.inkathon.Grocery.fragments.newProduct", this);
			}
		...
		fnOnNewCate: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("fragNewCate", "com.inkathon.Grocery.fragments.newItem", this);
			}
			this.getView().addDependent(this._oDialog);
		...
		fnOnNewBrand: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("fragNewBrand", "com.inkathon.Grocery.fragments.newItem", this);
			}
			this.getView().addDependent(this._oDialog);
		...
		fnOnNewUnit: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("fragNewUnit", "com.inkathon.Grocery.fragments.newItem", this);
			}
			this.getView().addDependent(this._oDialog);
		...
		fnOnFragDelCate: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("fragDelCat", "com.inkathon.Grocery.fragments.delete", this);
			}
	...
	/*	for_deleteRow: function (oEvent) {
		...
		filterDialog: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("fragBrandFilter", "com.inkathon.Grocery.fragments.productFilter", this);
			}
			this.getView().addDependent(this._oDialog);
